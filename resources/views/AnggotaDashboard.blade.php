...
<div class="col-xl-3 col-md-6 mb-4">
            <div class="card h-100 bg-gradient-primary">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col mr-2">
                            <div class="text-sm font-weight-bold text-uppercase mb-1 text-light">Jumlah Mobil</div>
                            <div class="text-sm text-light h5 mb-0 font-weight-bold">{{ $Mobil }}</div>
                            <div class="button mt-2"><a href="/Mobil" class="text-light">Lihat</a></div>
                        </div>
                        <div class="col-auto">
    ...
    <div class="container">
        ...
        <ol class=text-light>
            ...
            <li class=text-light>Setiap anggota hanya dapat meminjam maksima 1 Mobil</li>
            <li class=text-light>Jika pengenbalian buku lebih dari waktu yang ditentukan akan diberikan denda setiap Mobil Rp.150.000/minggu.</li>
            <li class=text-light>Jika telah meminjam buku,silahkan ke tempat petugas untuk melakukan konfirmasi</li>
            <li class=text-light>Jika Terlambat mengembalikan buku dan mendapat denda, maka wajib langsung membayar pada petugas saat mengembalikan Mobil</li>
        </ol>
    </div>
    </div>
@endsection
