            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }} ">
                        ...
                        <div class="row mb-3">
                            <label for="NomorSIM" class="col-md-4 col-form-label text-md-end text-dark">{{ __('NomorSIM') }}</label>

                            <div class="col-md-6">
                                <input id="NomorSIM" type="text" class="form-control @error('NomorSIM') is-invalid @enderror" name="NomorSIM" value="{{ old('NomorSIM') }}">
